...
var init = function() {
    ...
    if( wH >= 768 + titleH ){
     ...
     // 
        $(".waterBox .d.content > ul.videoUL").height(416);
        $(".waterBox .d.content > ul.bottomUL").css("top","426px");
        $(".waterBox .d.content > ul.middleUL > li:nth-child(2)").height(100);
        $(".waterBox .d.content > ul.middleUL > li:nth-child(3)").height(90);
        $(".waterBox .d.content > ul.bottomUL > li").height(220);
        $(".waterBox .d.content > ul.middleUL > li div[data-wheel='wheel']:nth-child(2)").height(66);
    }
    ...
    $(".waterBox .b.content,.waterBox .c.content,.waterBox .a.content,.waterBox .e.content").css(unti.mTranslate("150%", titleH + "px", 1, 1));
...
/////
    ...
    $(".waterBox .zhuangtai").css("margin-left","268px");

    var listInfo = eval('(' + data.value + ')').listInfo;
    for(var i in listInfo){
    	if (listInfo[i].id==GetQueryString("id")){
    		nowOpenStation = listInfo[i].name;
    		$(".waterBox .title").text(nowOpenStation);
    	}
    }
    ...
    setTimeout(function() {
       ...
       initWaterBoxData3m(nowOpenStation,false);
...
$(function(e) {
    ...
    $(".waterBox .zhuangtai span").on("click",function(e){
    	if(!$(this).hasClass("active")) {
            ...
            if($(this).index() == 0){
            	 initWaterBoxData3m(nowOpenStation,true);
                 isfirstLoadD = true;
                ...
                $(".waterBox > .title").css(unti.mTranslate(0, tT)).addClass('ok');
                moveContent("a");
                initWaterBox(nowOpenStation);
                isfirstLoadB = false;
            	//window.open("/buoyThreeAnalysis?0&id="+siteOption.station[nowOpenStation].id,'',''); 
    ...
    $(".waterBox > .d.content").addClass('ok');
