    ...
    public class FileHelper
    {
      ...
      public static bool IsExistDirectory(string directoryPath)  
        ...
        public static string FileToString(string filePath)  
        {
            ...
            return FileToString(filePath, encoding);  
        }  
        /// <summary>  
        /// 将文件读取到字符串中  
        /// </summary>  
        ...
        {  
            ...
            {  
                ...
                string errPath = System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + errVir;  
        ...
        {
            string errPath = System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + string.Format("/Log/Debug/{0}.html", DateTime.Now.ToShortDateString());  
