...
namespace Business.BN
{
    ...
    public class TABBUOYQIXG
    {
        ...
        public Entity.TABBUOYQIXG GetQiWenQiYaModel(string deviceCode)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            DbAPI dbHelper = new DbAPI();
            strSql.Append(" SELECT AVG(NVL(AIRTEM1,0)+NVL(AIRTEM2,0)+NVL(AIRTEM3,0)+ NVL(AIRTEM4,0)+NVL(AIRTEM5,0)+ NVL(AIRTEM6,0)+ NVL(AIRTEM7,0)+ NVL(AIRTEM8,0)+ NVL(AIRTEM9,0)+NVL(AIRTEM10,0)) AIRTEM, MAXAIRTEM, MAXAIRTEMTIME, MINAIRTEM, MINAIRTEMTIME, AVG(NVL(HUMI1,0)+ NVL(HUMI2,0)+ NVL(HUMI3,0)+ NVL(HUMI4,0)+ NVL(HUMI5,0)+ NVL(HUMI6,0)+ NVL(HUMI7,0)+ NVL(HUMI8,0)+ NVL(HUMI9,0)+ NVL(HUMI10,0)) HUM, MAXHUMI, MAXHUMITIME, MINHUMI, MINHUMITIME, AVG(NVL(PRESSURE1,0)+ NVL(PRESSURE2,0)+ NVL(PRESSURE3,0)+ NVL(PRESSURE4,0)+ NVL(PRESSURE5,0)+ NVL(PRESSURE6,0)+ NVL(PRESSURE7,0)+ NVL(PRESSURE8,0)+ NVL(PRESSURE9,0)+ NVL(PRESSURE10,0)) PRESSURE, MAXPRESSURE, MAXPRESSURETIME, MINPRESSURE, MINPRESSURETIME ");
            ...
            strSql.Append(" GROUP BY MAXAIRTEM, MAXAIRTEMTIME, MINAIRTEM, MINAIRTEMTIME, MAXHUMI, MAXHUMITIME, MINHUMI, MINHUMITIME,MAXPRESSURE, MAXPRESSURETIME, MINPRESSURE, MINPRESSURETIME ");
            ...
            if (ds.Rows.Count > 0)
            {
                ...
                if (ds.Rows[0]["AIRTEM1"].ToString() != "")
                {
                    model.AIRTEM1 = decimal.Parse(ds.Rows[0]["AIRTEM1"].ToString());
                }
                if (ds.Rows[0]["AIRTEM2"].ToString() != "")
                {
                    model.AIRTEM2 = decimal.Parse(ds.Rows[0]["AIRTEM2"].ToString());
                }
                if (ds.Rows[0]["AIRTEM3"].ToString() != "")
                {
                    model.AIRTEM3 = decimal.Parse(ds.Rows[0]["AIRTEM3"].ToString());
                }
                if (ds.Rows[0]["AIRTEM4"].ToString() != "")
                {
                    model.AIRTEM4 = decimal.Parse(ds.Rows[0]["AIRTEM4"].ToString());
                }
                if (ds.Rows[0]["AIRTEM5"].ToString() != "")
                {
                    model.AIRTEM5 = decimal.Parse(ds.Rows[0]["AIRTEM5"].ToString());
                }
                if (ds.Rows[0]["AIRTEM6"].ToString() != "")
                {
                    model.AIRTEM6 = decimal.Parse(ds.Rows[0]["AIRTEM6"].ToString());
                }
                if (ds.Rows[0]["AIRTEM7"].ToString() != "")
                {
                    model.AIRTEM7 = decimal.Parse(ds.Rows[0]["AIRTEM7"].ToString());
                }
                if (ds.Rows[0]["AIRTEM8"].ToString() != "")
                {
                    model.AIRTEM8 = decimal.Parse(ds.Rows[0]["AIRTEM8"].ToString());
                }
                if (ds.Rows[0]["AIRTEM9"].ToString() != "")
                {
                    model.AIRTEM9 = decimal.Parse(ds.Rows[0]["AIRTEM9"].ToString());
                }
                if (ds.Rows[0]["AIRTEM10"].ToString() != "")
                {
                    model.AIRTEM10 = decimal.Parse(ds.Rows[0]["AIRTEM10"].ToString());
                }
                ...
                if (ds.Rows[0]["HUMI1"].ToString() != "")
                {
                    model.HUMI1 = decimal.Parse(ds.Rows[0]["HUMI1"].ToString());
                }
                if (ds.Rows[0]["HUMI2"].ToString() != "")
                {
                    model.HUMI2 = decimal.Parse(ds.Rows[0]["HUMI2"].ToString());
                }
                if (ds.Rows[0]["HUMI3"].ToString() != "")
                {
                    model.HUMI3 = decimal.Parse(ds.Rows[0]["HUMI3"].ToString());
                }
                if (ds.Rows[0]["HUMI4"].ToString() != "")
                {
                    model.HUMI4 = decimal.Parse(ds.Rows[0]["HUMI4"].ToString());
                }
                if (ds.Rows[0]["HUMI5"].ToString() != "")
                {
                    model.HUMI5 = decimal.Parse(ds.Rows[0]["HUMI5"].ToString());
                }
                if (ds.Rows[0]["HUMI6"].ToString() != "")
                {
                    model.HUMI6 = decimal.Parse(ds.Rows[0]["HUMI6"].ToString());
                }
                if (ds.Rows[0]["HUMI7"].ToString() != "")
                {
                    model.HUMI7 = decimal.Parse(ds.Rows[0]["HUMI7"].ToString());
                }
                if (ds.Rows[0]["HUMI8"].ToString() != "")
                {
                    model.HUMI8 = decimal.Parse(ds.Rows[0]["HUMI8"].ToString());
                }
                if (ds.Rows[0]["HUMI9"].ToString() != "")
                {
                    model.HUMI9 = decimal.Parse(ds.Rows[0]["HUMI9"].ToString());
                }
                if (ds.Rows[0]["HUMI10"].ToString() != "")
                {
                    model.HUMI10 = decimal.Parse(ds.Rows[0]["HUMI10"].ToString());
                }
                ...
                if (ds.Rows[0]["PRESSURE1"].ToString() != "")
                {
                    model.PRESSURE1 = decimal.Parse(ds.Rows[0]["PRESSURE1"].ToString());
                }
                if (ds.Rows[0]["PRESSURE2"].ToString() != "")
                {
                    model.PRESSURE2 = decimal.Parse(ds.Rows[0]["PRESSURE2"].ToString());
                }
                if (ds.Rows[0]["PRESSURE3"].ToString() != "")
                {
                    model.PRESSURE3 = decimal.Parse(ds.Rows[0]["PRESSURE3"].ToString());
                }
                if (ds.Rows[0]["PRESSURE4"].ToString() != "")
                {
                    model.PRESSURE4 = decimal.Parse(ds.Rows[0]["PRESSURE4"].ToString());
                }
                if (ds.Rows[0]["PRESSURE5"].ToString() != "")
                {
                    model.PRESSURE5 = decimal.Parse(ds.Rows[0]["PRESSURE5"].ToString());
                }
                if (ds.Rows[0]["PRESSURE6"].ToString() != "")
                {
                    model.PRESSURE6 = decimal.Parse(ds.Rows[0]["PRESSURE6"].ToString());
                }
                if (ds.Rows[0]["PRESSURE7"].ToString() != "")
                {
                    model.PRESSURE7 = decimal.Parse(ds.Rows[0]["PRESSURE7"].ToString());
                }
                if (ds.Rows[0]["PRESSURE8"].ToString() != "")
                {
                    model.PRESSURE8 = decimal.Parse(ds.Rows[0]["PRESSURE8"].ToString());
                }
                if (ds.Rows[0]["PRESSURE9"].ToString() != "")
                {
                    model.PRESSURE9 = decimal.Parse(ds.Rows[0]["PRESSURE9"].ToString());
                }
                if (ds.Rows[0]["PRESSURE10"].ToString() != "")
                {
                    model.PRESSURE10 = decimal.Parse(ds.Rows[0]["PRESSURE10"].ToString());
                }
                ...
                if (ds.Rows[0]["WINDSPD1"].ToString() != "")
                {
                    model.WINDSPD1 = decimal.Parse(ds.Rows[0]["WINDSPD1"].ToString());
                }
                if (ds.Rows[0]["WINDDIR1"].ToString() != "")
                {
                    model.WINDDIR1 = decimal.Parse(ds.Rows[0]["WINDDIR1"].ToString());
                }
                if (ds.Rows[0]["WINDSPD2"].ToString() != "")
                {
                    model.WINDSPD2 = decimal.Parse(ds.Rows[0]["WINDSPD2"].ToString());
                }
                if (ds.Rows[0]["WINDDIR2"].ToString() != "")
                {
                    model.WINDDIR2 = decimal.Parse(ds.Rows[0]["WINDDIR2"].ToString());
                }
                if (ds.Rows[0]["WINDSPD3"].ToString() != "")
                {
                    model.WINDSPD3 = decimal.Parse(ds.Rows[0]["WINDSPD3"].ToString());
                }
                if (ds.Rows[0]["WINDDIR3"].ToString() != "")
                {
                    model.WINDDIR3 = decimal.Parse(ds.Rows[0]["WINDDIR3"].ToString());
                }
                if (ds.Rows[0]["WINDSPD4"].ToString() != "")
                {
                    model.WINDSPD4 = decimal.Parse(ds.Rows[0]["WINDSPD4"].ToString());
                }
                if (ds.Rows[0]["WINDDIR4"].ToString() != "")
                {
                    model.WINDDIR4 = decimal.Parse(ds.Rows[0]["WINDDIR4"].ToString());
                }
                if (ds.Rows[0]["WINDSPD5"].ToString() != "")
                {
                    model.WINDSPD5 = decimal.Parse(ds.Rows[0]["WINDSPD5"].ToString());
                }
                if (ds.Rows[0]["WINDDIR5"].ToString() != "")
                {
                    model.WINDDIR5 = decimal.Parse(ds.Rows[0]["WINDDIR5"].ToString());
                }
                if (ds.Rows[0]["WINDSPD6"].ToString() != "")
                {
                    model.WINDSPD6 = decimal.Parse(ds.Rows[0]["WINDSPD6"].ToString());
                }
                if (ds.Rows[0]["WINDDIR6"].ToString() != "")
                {
                    model.WINDDIR6 = decimal.Parse(ds.Rows[0]["WINDDIR6"].ToString());
                }
                if (ds.Rows[0]["WINDSPD7"].ToString() != "")
                {
                    model.WINDSPD7 = decimal.Parse(ds.Rows[0]["WINDSPD7"].ToString());
                }
                if (ds.Rows[0]["WINDDIR7"].ToString() != "")
                {
                    model.WINDDIR7 = decimal.Parse(ds.Rows[0]["WINDDIR7"].ToString());
                }
                if (ds.Rows[0]["WINDSPD8"].ToString() != "")
                {
                    model.WINDSPD8 = decimal.Parse(ds.Rows[0]["WINDSPD8"].ToString());
                }
                if (ds.Rows[0]["WINDDIR8"].ToString() != "")
                {
                    model.WINDDIR8 = decimal.Parse(ds.Rows[0]["WINDDIR8"].ToString());
                }
                if (ds.Rows[0]["WINDSPD9"].ToString() != "")
                {
                    model.WINDSPD9 = decimal.Parse(ds.Rows[0]["WINDSPD9"].ToString());
                }
                if (ds.Rows[0]["WINDDIR9"].ToString() != "")
                {
                    model.WINDDIR9 = decimal.Parse(ds.Rows[0]["WINDDIR9"].ToString());
                }
                if (ds.Rows[0]["WINDSPD10"].ToString() != "")
                {
                    model.WINDSPD10 = decimal.Parse(ds.Rows[0]["WINDSPD10"].ToString());
                }
                if (ds.Rows[0]["WINDDIR10"].ToString() != "")
                {
                    model.WINDDIR10 = decimal.Parse(ds.Rows[0]["WINDDIR10"].ToString());
                }
                ...
                if (ds.Rows[0]["AVEWINDSPD1"].ToString() != "")
                {
                    model.AVEWINDSPD1 = decimal.Parse(ds.Rows[0]["AVEWINDSPD1"].ToString());
                }
                if (ds.Rows[0]["AVEWINDDIR1"].ToString() != "")
                {
                    model.AVEWINDDIR1 = decimal.Parse(ds.Rows[0]["AVEWINDDIR1"].ToString());
                }
                if (ds.Rows[0]["AVEWINDSPD2"].ToString() != "")
                {
                    model.AVEWINDSPD2 = decimal.Parse(ds.Rows[0]["AVEWINDSPD2"].ToString());
                }
                if (ds.Rows[0]["AVEWINDDIR2"].ToString() != "")
                {
                    model.AVEWINDDIR2 = decimal.Parse(ds.Rows[0]["AVEWINDDIR2"].ToString());
                }
                if (ds.Rows[0]["AVEWINDSPD3"].ToString() != "")
                {
                    model.AVEWINDSPD3 = decimal.Parse(ds.Rows[0]["AVEWINDSPD3"].ToString());
                }
                if (ds.Rows[0]["AVEWINDDIR3"].ToString() != "")
                {
                    model.AVEWINDDIR3 = decimal.Parse(ds.Rows[0]["AVEWINDDIR3"].ToString());
                }
                if (ds.Rows[0]["AVEWINDSPD4"].ToString() != "")
                {
                    model.AVEWINDSPD4 = decimal.Parse(ds.Rows[0]["AVEWINDSPD4"].ToString());
                }
                if (ds.Rows[0]["AVEWINDDIR4"].ToString() != "")
                {
                    model.AVEWINDDIR4 = decimal.Parse(ds.Rows[0]["AVEWINDDIR4"].ToString());
                }
                if (ds.Rows[0]["AVEWINDSPD5"].ToString() != "")
                {
                    model.AVEWINDSPD5 = decimal.Parse(ds.Rows[0]["AVEWINDSPD5"].ToString());
                }
                if (ds.Rows[0]["AVEWINDDIR5"].ToString() != "")
                {
                    model.AVEWINDDIR5 = decimal.Parse(ds.Rows[0]["AVEWINDDIR5"].ToString());
                }
                if (ds.Rows[0]["AVEWINDSPD6"].ToString() != "")
                {
                    model.AVEWINDSPD6 = decimal.Parse(ds.Rows[0]["AVEWINDSPD6"].ToString());
                }
                if (ds.Rows[0]["AVEWINDDIR6"].ToString() != "")
                {
                    model.AVEWINDDIR6 = decimal.Parse(ds.Rows[0]["AVEWINDDIR6"].ToString());
                }
                if (ds.Rows[0]["AVEWINDSPD7"].ToString() != "")
                {
                    model.AVEWINDSPD7 = decimal.Parse(ds.Rows[0]["AVEWINDSPD7"].ToString());
                }
                if (ds.Rows[0]["AVEWINDDIR7"].ToString() != "")
                {
                    model.AVEWINDDIR7 = decimal.Parse(ds.Rows[0]["AVEWINDDIR7"].ToString());
                }
                if (ds.Rows[0]["AVEWINDSPD8"].ToString() != "")
                {
                    model.AVEWINDSPD8 = decimal.Parse(ds.Rows[0]["AVEWINDSPD8"].ToString());
                }
                if (ds.Rows[0]["AVEWINDDIR8"].ToString() != "")
                {
                    model.AVEWINDDIR8 = decimal.Parse(ds.Rows[0]["AVEWINDDIR8"].ToString());
                }
                if (ds.Rows[0]["AVEWINDSPD9"].ToString() != "")
                {
                    model.AVEWINDSPD9 = decimal.Parse(ds.Rows[0]["AVEWINDSPD9"].ToString());
                }
                if (ds.Rows[0]["AVEWINDDIR9"].ToString() != "")
                {
                    model.AVEWINDDIR9 = decimal.Parse(ds.Rows[0]["AVEWINDDIR9"].ToString());
                }
                if (ds.Rows[0]["AVEWINDSPD10"].ToString() != "")
                {
                    model.AVEWINDSPD10 = decimal.Parse(ds.Rows[0]["AVEWINDSPD10"].ToString());
                }
                if (ds.Rows[0]["AVEWINDDIR10"].ToString() != "")
                {
                    model.AVEWINDDIR10 = decimal.Parse(ds.Rows[0]["AVEWINDDIR10"].ToString());
                }
                if (ds.Rows[0]["RESERV0"].ToString() != "")
                {
                    model.RESERV0 = decimal.Parse(ds.Rows[0]["RESERV0"].ToString());
                }
                if (ds.Rows[0]["RESERV1"].ToString() != "")
                {
                    model.RESERV1 = decimal.Parse(ds.Rows[0]["RESERV1"].ToString());
                }
                if (ds.Rows[0]["RESERV2"].ToString() != "")
                {
                    model.RESERV2 = decimal.Parse(ds.Rows[0]["RESERV2"].ToString());
                }
                if (ds.Rows[0]["RESERV3"].ToString() != "")
                {
                    model.RESERV3 = decimal.Parse(ds.Rows[0]["RESERV3"].ToString());
                }
                if (ds.Rows[0]["RESERV4"].ToString() != "")
                {
                    model.RESERV4 = decimal.Parse(ds.Rows[0]["RESERV4"].ToString());
                }
                if (ds.Rows[0]["RESERV5"].ToString() != "")
                {
                    model.RESERV5 = decimal.Parse(ds.Rows[0]["RESERV5"].ToString());
                }
                if (ds.Rows[0]["RESERV6"].ToString() != "")
                {
                    model.RESERV6 = decimal.Parse(ds.Rows[0]["RESERV6"].ToString());
                }
                if (ds.Rows[0]["RESERV7"].ToString() != "")
                {
                    model.RESERV7 = decimal.Parse(ds.Rows[0]["RESERV7"].ToString());
                }
                if (ds.Rows[0]["RESERV8"].ToString() != "")
                {
                    model.RESERV8 = decimal.Parse(ds.Rows[0]["RESERV8"].ToString());
                }
                if (ds.Rows[0]["RESERV9"].ToString() != "")
                {
                    model.RESERV9 = decimal.Parse(ds.Rows[0]["RESERV9"].ToString());
                }
                if (ds.Rows[0]["RESERV10"].ToString() != "")
                {
                    model.RESERV10 = decimal.Parse(ds.Rows[0]["RESERV10"].ToString());
                }
                if (ds.Rows[0]["RESERV11"].ToString() != "")
                {
                    model.RESERV11 = decimal.Parse(ds.Rows[0]["RESERV11"].ToString());
                }
                if (ds.Rows[0]["RESERV12"].ToString() != "")
                {
                    model.RESERV12 = decimal.Parse(ds.Rows[0]["RESERV12"].ToString());
                }
                if (ds.Rows[0]["RESERV13"].ToString() != "")
                {
                    model.RESERV13 = decimal.Parse(ds.Rows[0]["RESERV13"].ToString());
                }
                if (ds.Rows[0]["RESERV14"].ToString() != "")
                {
                    model.RESERV14 = decimal.Parse(ds.Rows[0]["RESERV14"].ToString());
                }
