...
function (a, b) {
    ...
    var n = {
        dialog: "<div class='bootbox modal' tabindex='-1' role='dialog'><div class='modal-dialog'><div class='modal-content'><div style='height:40px;line-height:40px;text-indent:20px;background:#088ddc;color:#fff;font-size:16px;font-weight:bold;'>提示信息</div><div class='modal-body'><div class='bootbox-body'></div></div></div></div></div>",
