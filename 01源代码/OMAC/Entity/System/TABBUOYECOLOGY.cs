...
namespace Entity 
{
	...
	public class TABBUOYECOLOGY
	{
        ...
        /// </summary>
        [DataMember]
		public decimal CURRENTTEM { get; set; }
		/// <summary>
        /// WATERTEM
        /// </summary>
        [DataMember]
        ...
        /// </summary>
        [DataMember]
		public decimal YLS { get; set; }
		/// <summary>
        /// YLSTEM
        /// </summary>
        [DataMember]
		public decimal YLSTEM { get; set; }
		/// <summary>
        /// UNDERWATERCO2
        /// </summary>
        [DataMember]
