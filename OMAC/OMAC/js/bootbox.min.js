...
function (a, b) {
    ...
    var n = {
        dialog: "<div class='bootbox modal' tabindex='-1' role='dialog'><div class='modal-dialog'><div class='modal-content' style='border:1px #088ddc;'><div style='height:40px;line-height:40px;text-indent:20px;background:#088ddc;color:#fff;font-size:16px;font-weight:bold;'>提示</div><div class='modal-body'><div class='bootbox-body' style='margin-top:10px;font-family:'黑体''></div></div></div></div></div>",
    ...
    p.callbackalert = function () {
        var a;
        if (a = k("confirm", ["confirm"], ["message", "callback"], arguments), a.buttons.confirm.callback = function () {
            return a.callback.call(this, !0)
        }, !b.isFunction(a.callback)) throw new Error("confirm requires a callback");
        return p.dialog(a)
    },
